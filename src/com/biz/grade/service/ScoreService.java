...
public class ScoreService {
	 ...
	 * 3. 이미 점수가 입력되어 있는 경우에는 점수를 보여주고
	 * 4. 점수를 입력하지 않고 Enter를 누르면 기존 점수를 유지하고
	 * 	>> 수정 상태로 변경
	 * 5. 점수가 없는 경우에는 새로운 점수를 입력받고
	 * 6. 점수를 insert한다.
	 */
	private void insertScore() {
		...
		// 학번을 입력했으면
		// 학생정보로부터 학번에 대한 학생데이터를 조회해서 보여주기
		...
		if(scVO != null) {
			...
			System.out.println("----------------------------------------");
			System.out.println(scVO.getSc_num() + "\t");
			System.out.println(scVO.getSc_kor() + "\t");
			System.out.println(scVO.getSc_eng() + "\t");
			System.out.println(scVO.getSc_math() + "\n");
			System.out.println("----------------------------------------");
		}
